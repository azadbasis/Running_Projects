...
////////////////////////// DataBase Initialize  Here /////////////////////////////////////////////////////////////
    ...
    String CREATE_TABLE_STUDENT= " CREATE TABLE " + TABLE_STUDENT_INFO + " ( "+ COL_ID + " INTEGER PRIMARY KEY, "+ COL_STUDENT_ID + " TEXT, " + COL_NAME + " TEXT, "+ COL_DEPT + " TEXT, "+ COL_CREDITS + " TEXT, "+ COL_WEAVER + " TEXT, "+ COL_BALANCE + " TEXT, "+ COL_CELLPHONE + " TEXT, "+ COL_EMAIL + " TEXT )";
